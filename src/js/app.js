App = {
    ...
    sellItem: function (event) {
        event.preventDefault();
        var processId = parseInt($(event.target).data('id'));
        App.productPrice = $('#salePrice').val();
        App.upc = $("#upcInput").val();
        App.contracts.SupplyChain.deployed().then(function(instance) {
    ...
    buyItem: function (event) {
        event.preventDefault();
        var processId = parseInt($(event.target).data('id'));
        App.productPrice = $('#purchasePrice').val();
        App.upc = $("#upcInput2").val();
        App.contracts.SupplyChain.deployed().then(function(instance) {
    ...
    ///    var processId = parseInt($(event.target).data('id'));
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
          return instance.fetchItemBufferOne(App.upc);
            ...
            $("#sku").val(result[0].toNumber());
            $("#upc").val(result[1].toNumber());
            $("#ownerId").val(result[2]); 
            $("#farmerId").val(result[3]);
            $("#farmName").val(result[4]);
            $("#farmInfo").val(result[5]);
            $("#farmLat").val(result[6]);
            $("#farmLong").val(result[7]);
        }).catch(function(err) {
          console.log(err.message);
        });
    },
    ...
    App.contracts.SupplyChain.deployed().then(function(instance) {
        ...
        $("#sku").val(result[0].toNumber());
        $("#upc").val(result[1].toNumber());
        $("#productId").val(result[2].toNumber()); 
        $("#productNote").val(result[3]);
    ...
    addFarmer: function () {     
        App.originFarmerID = $('#roleAddress').val();
    ...
    addDistributor: function () {     
        App.distributorID = $('#roleAddress').val();
    ...
    addRetailer: function () {     
        App.retailerID = $('#roleAddress').val();
    ...
    addConsumer: function () {     
        App.consumerID = $('#roleAddress').val();
