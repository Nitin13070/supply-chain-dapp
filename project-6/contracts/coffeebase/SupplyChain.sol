...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole, Ownable {
  ...
  function harvestItem(uint _upc, address _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, string memory  _originFarmLatitude, string memory  _originFarmLongitude, string  memory _productNotes) onlyFarmer public 
  {
    ...
    Item memory newItem = Item(sku, _upc, msg.sender, _originFarmerID, _originFarmName, _originFarmInformation, _originFarmLatitude, _originFarmLongitude, (sku + _upc), _productNotes, 0, defaultState, address(0), address(0), address(0));
    items[_upc] = newItem;
